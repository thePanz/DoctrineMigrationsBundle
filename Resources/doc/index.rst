...
---------------------------
DoctrineMigrations rely on a properly configured Database server version in the connection string to manage the table storing the
migrations, also known as the MetadataStorage.
